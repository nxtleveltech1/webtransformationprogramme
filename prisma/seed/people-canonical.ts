...
export const CANONICAL_PEOPLE: CanonicalPerson[] = [
  { key: "gareth bew", displayName: "Gareth", surname: "Bew", aliases: ["gareth", "gb"] },
  {
    ...
    displayName: "Keshvi",
    surname: "Singh",
    aliases: ["keshvi", "keshi", "keshi singh"],
  },
  ...
  { key: "megan harrison", displayName: "Megan", surname: "Harrison", aliases: ["megan"] },
  { key: "marlana moller", displayName: "Marlana", surname: "Moller", aliases: ["marlana"] },
  { key: "rey uys", displayName: "Rey", surname: "Uys", aliases: ["rey"] },
  {
    key: "mosala philips",
    displayName: "Mosala",
    surname: "Philips",
